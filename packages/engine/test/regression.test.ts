 ...
 */
// Neu erzeugt nach der bewussten Schildänderung auf acht Abschnitte. Ein
// Treffer lädt nun um 1/8 bis 3/8 statt um 1/7 bis 3/7; dadurch fällt ein
// Block im Mittel später. Decklisten und Kartenwerte sind unverändert.
//
// Davor: neu erzeugt am 2026-08-09, nachdem Test und Generator auf die vier in
...
const GOLDEN_MASTER: [string, string, number, string, string][] = [
  ['forschung_muskelkraft', 'rudeljaeger', 5000, '1:5:-2:7:10', '7480f216'],
  ['rudeljaeger', 'forschung_muskelkraft', 5001, '1:7:0:2:14', 'b0991d0f'],
  ['forschung_muskelkraft', 'solidaritaet_ueberleben', 5002, '0:10:6:-2:24', 'aab39f6d'],
  ['solidaritaet_ueberleben', 'forschung_muskelkraft', 5003, '1:10:-1:5:17', '9d098099'],
  ['forschung_muskelkraft', 'urzeitliche_kolosse', 5004, '1:5:0:1:9', '89fda7c6'],
  ['urzeitliche_kolosse', 'forschung_muskelkraft', 5005, '0:5:7:-2:8', '16f91a89'],
  ['rudeljaeger', 'solidaritaet_ueberleben', 5006, '0:6:6:-1:14', 'e209b0e1'],
  ['solidaritaet_ueberleben', 'rudeljaeger', 5007, '1:7:0:8:15', 'e8e9b4cc'],
  ['rudeljaeger', 'urzeitliche_kolosse', 5008, '1:9:-1:4:24', 'dc937fcd'],
  ['urzeitliche_kolosse', 'rudeljaeger', 5009, '1:5:-2:7:9', 'd43ee80a'],
  ['solidaritaet_ueberleben', 'urzeitliche_kolosse', 5010, '1:10:0:10:20', 'ccbe476a'],
  ['urzeitliche_kolosse', 'solidaritaet_ueberleben', 5011, '0:8:2:-1:15', 'b20522a6']
];
